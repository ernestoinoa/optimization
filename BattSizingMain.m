...
% during a single day.  Hence, if ran for different seasons,
% changes have to be made in BattSizingCost. For instance,
% the right info about Irradiation and kWh prices have to be
% included.
% -----------------------------
...
for NumofBattPacks = 1:50,
    ...
    limits(iphase).time.min       = [0 3600*24.0];
    limits(iphase).time.max       = [0 3600*24.0];
    ...
    %setup.method = 'gauss';
    setup.funcs.cost = 'BattSizingCost';
